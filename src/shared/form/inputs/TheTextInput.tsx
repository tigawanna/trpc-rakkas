...
return (
  ...
  >
    <label
      ...
      className={twMerge("text px-2 font-serif font-bold",props.label_classname)}>
    ...
    {editing ? (
      <div className="flex w-full flex-col  ">
        <input
          ...
          className={twMerge("input input-bordered input-sm w-full border-accent",
            props.className
          )}
        />
        {(props.description && editing) && (
          <p className={twMerge("text-xs italic text-info", props.description_classname)}>
            {props.description}
          </p>
        )}
      </div>
